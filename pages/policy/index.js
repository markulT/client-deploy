        ...
        <div className={'min-h-[100%] font-[Inter] w-full bg-gradient-to-r from-grad_from to-grad_to'}>
            <div className='container min-h-screen mx-auto pt-4'>
                <div className="bg-grad_from pl-4 pr-4 rounded-3xl">
                    ...
                    <p className={'text-xl mt-2'}>2.Обробка і зберігання наданих персональних даних здійснюється в датацентрах, де розміщується обладнання, що забезпечує функціонування сервісів Сайту. Надані персональні дані обробляються і можуть зберігатись в Базі персональних даних чи окремій таблиці Бази даних Сайту.</p>
                    <p className={'text-xl mt-2'}>3. Місцезнаходженням Компанії є Ізраїль, Хайфа 26101 .</p>
