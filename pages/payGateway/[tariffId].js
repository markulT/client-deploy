...
export default function PaymentGateway() {
    ...
    return (
        <div className="w-full min-h-screen bg-gradient-to-t from-grad_from to-grad_to">
            ...
            <h1 className="text-2xl text-gray-200 sm:text-3xl text-center font-bold mt-[-70px] ">Покупка подписки <br/> <h1 className="text-gray-200 text-4xl ">{actionId == "standart" ? "Standart" : actionId == "premium" ? "Premium" : actionId == "minimal" ? "Minimal" : "Mobile Maximum"}</h1></h1>
