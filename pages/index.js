        ...
        <div className="w-full overflow-hidden">
            ...
            <div x-show="open"
                ...
                <div className="w-full text-white text-sm sm:text-md ">Этот веб-сайт использует файлы cookie, чтобы
                    ...
                    <a href="#"
                       className="text-indigo-300 whitespace-nowrap  hover:underline text-sm sm:text-md transition-all duration-300"> Читать
                        больше</a></div>
                <div className="flex gap-4 items-center flex-shrink-0">
                    <button
                        className="text-indigo-300 focus:outline-none hover:underline text-sm pl-5 sm:pl-0 transition-all duration-300"
                        onClick={() => {
                            setHidden(true)
                            setCookie('cookieAccept', 'hidden')
                        }}>Отклонить
                    </button>
                    <button
                        className="bg-indigo-500 sm:px-5 sm:py-2 px-2 py-2 text-sm sm:text-md mr-3 sm:mr-0 text-white rounded-md hover:bg-indigo-700 focus:outline-none transition-all duration-300"
                        onClick={() => {
                            setHidden(true)
                            setCookie('cookieAccept', 'hidden')
                        }}>Разрешить Coockies
